...
public class PlanController {
    ...
    public ResponseEntity<?> createPlan(@RequestBody(required = false) String planObject) {
        ...
        System.out.println("DemoApplication.queueName: " + DemoApplication.queueName);
    ...
    public ResponseEntity<?> getPlan(@PathVariable String objectId,
        ...
        try {
            ...
            ifNoneMatch = headers.getFirst("If-None-Match");
        } catch (Exception e) {
        ...
        if (objectType.equals("plan") && ifNoneMatch != null && ifNoneMatch != "" &&ifNoneMatch.equals(eTag))
            return new ResponseEntity<Object>(null, headersToSend, HttpStatus.NOT_MODIFIED);

        else if (objectType.equals("plan") && ifNoneMatch != null && !ifNoneMatch.equals(eTag))
        	return new ResponseEntity<String>("{\"message\": \"No Plan with specified ETag Found\" }", HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<?> deletePlan(@PathVariable String objectId,
        ...
        return new ResponseEntity<String>("{\"message\": \"Plan deleted successfully\"}",
                HttpStatus.OK);
    }
